...
// 滁州纪委监委
router.get('/gov/chuzhou/jwjw/:caty', lazyloadRouteHandler('./routes/gov/chuzhou/jwjw'));

// 池州纪委监委
router.get('/gov/chizhou/jwjw/:caty', lazyloadRouteHandler('./routes/gov/chizhou/jwjw'));
